            ...
            {[3, 4, 5, 6].map((d) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={() => setDays(d)}
                  className={`inline-flex items-center justify-center rounded-[1rem] border px-4 py-3 text-sm font-medium transition duration-200 ${
                    selected
                      ? "border-green-400 bg-green-500 text-black shadow-[0_10px_30px_rgba(34,197,94,0.28)]"
                      : "border-white/10 bg-black/26 text-zinc-300 hover:border-white/18 hover:bg-white/[0.05]"
                  }`}
