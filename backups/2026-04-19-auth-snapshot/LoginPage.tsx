  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleLogin} className="space-y-5">
        ...
        <div className="flex items-center justify-between text-sm text-zinc-400">
          ...
          <Link
            ...
            className="text-green-400/90 transition hover:text-green-300 hover:underline"
          >
            Esqueci a senha
          </Link>
        </div>
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center rounded-[1.35rem] bg-green-500 px-6 py-4 text-lg font-semibold text-black shadow-lg shadow-green-500/20 transition-all duration-200 hover:scale-[1.02] hover:bg-green-400 hover:shadow-green-500/40 disabled:cursor-not-allowed disabled:opacity-60"
        >
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2.5 overflow-hidden rounded-[1.35rem] border border-white/20 bg-white/10 px-4 py-3.5 text-sm font-semibold text-white shadow-[0_12px_34px_rgba(0,0,0,0.18)] transition-all duration-200 hover:scale-[1.01] hover:border-white/25 hover:bg-white/10 hover:shadow-[0_16px_40px_rgba(0,0,0,0.22)] disabled:cursor-not-allowed disabled:opacity-60"
      >
        {googleLoading ? (
          <LoaderCircle className="h-5 w-5 shrink-0 animate-spin" />
        ) : (
          <span className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white/90 text-xs font-black text-zinc-950 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.08)]">
            G
          </span>
        )}
        <span>
